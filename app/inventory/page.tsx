...
import { mockInventoryLogs, mockProducts } from '@/lib/mock-data'
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-stone-100">
                    ...
                    <th className="text-left py-2.5 px-4 text-xs font-semibold text-stone-500 uppercase">Location</th>
                  ...
                  {filtered.map(product => {
                    ...
                    return (
                      <tr key={product.id} className="hover:bg-stone-50 transition-colors group">
                        ...
                        <td className="py-2.5 px-4 text-xs text-stone-500">{product.inventory?.warehouse_location ?? '—'}</td>
